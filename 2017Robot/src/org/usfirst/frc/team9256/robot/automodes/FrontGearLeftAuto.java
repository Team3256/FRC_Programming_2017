...
public class FrontGearLeftAuto extends CommandGroup {
	public FrontGearLeftAuto() {
		...
		addSequential(new DelayedCommand(0.25, new PIDTurn(60, true, false))); //turn towards gear
		addSequential(new DelayedCommand(0.5, new DriveToDistance(65, true))); //drive towards gear
		addParallel(new DeployFrontGear());
		addSequential(new DelayedCommand(0.6, new DriveToDistance(45, false))); //drive backwards
		addSequential(new DelayedCommand(0.5, new PIDTurn(60, false, false))); //turn to midfield
